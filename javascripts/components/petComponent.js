const pets = [
    ...
    {name: "Tiger", color: "Black", specialSkill: "Can read (but cannot understand) Hebrew.", type: "dog", imageUrl: "http://dogzforever.com/wp-content/uploads/2017/08/akc-funny-basset-hound-yawn-ears.jpg"}
]
